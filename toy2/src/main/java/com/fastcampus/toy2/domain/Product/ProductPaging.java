...
public class ProductPaging {
    ...
    public  final int NAV_SIZE = 12; // page navigation size
    ...
    public ProductPaging(int totalCnt, Integer page) {
        this(totalCnt, new SearchCondition(page, 12));
    }

    public ProductPaging(int totalCnt, Integer page, Integer pageSize) {
        this(totalCnt, new SearchCondition(page, pageSize));
    }

    public ProductPaging(int totalCnt, SearchCondition sc) {
